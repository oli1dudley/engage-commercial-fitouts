...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/locations/the-meadows-movers",
});
...
const FEATURES = [
  ...
  { icon: Building2, title: "Premium villa moves in The Meadows", description: "We handle large villa moves across The Meadows, including careful management of premium furniture and belongings." },
...
const FAQ_ITEMS: FAQItem[] = [
  { question: "Do you move villas in The Meadows?", answer: "Yes. We handle full villa moves across The Meadows, including careful packing, furniture dismantling, transport and reassembly at your new home." },
  { question: "How do you handle large villa furniture in The Meadows?", answer: "We dismantle large furniture before the move and reassemble it carefully at your new property. Our team brings all tools required for the job." },
  { question: "Do you offer packing services in The Meadows?", answer: "Yes. Full packing and unpacking services are available for The Meadows moves. We use quality materials to protect all items during transport." },
  { question: "How do I get a moving quote for The Meadows?", answer: "Submit a quote request through our website or contact us directly. We'll respond quickly with a tailored quote for your Meadows villa move." },
];

export default function TheMeadowsMoversPage() {
  return (
    <>
      <StructuredData data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "The Meadows Movers", url: "/locations/the-meadows-movers" }])} />
      <StructuredData data={serviceSchema({ name: "Movers in The Meadows", description: "Professional villa moving services across The Meadows, Dubai.", url: "/locations/the-meadows-movers", serviceType: "MovingService" })} />
      <StructuredData data={faqPageSchema(FAQ_ITEMS)} />

      <PageHero
        headline="Movers in The Meadows"
        subheadline="Professional villa moving services across The Meadows, including careful packing, furniture dismantling, transport and full setup."
        body="The Meadows is a premium villa community in Dubai. WeMoveStuff provides professional moving support for The Meadows residents."
        ...
        trustBadges={["The Meadows Coverage", "Villa Specialists", "Packing Available", "Furniture Assembly"]}
        variant="centered"
      />
        ...
        <div className="max-container container-padding py-3">
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center flex-wrap gap-1 text-sm">
              ...
              <li><span className="font-medium text-navy" aria-current="page">The Meadows Movers</span></li>
            </ol>
          </nav>
        </div>
      </section>
        ...
        <div className="max-container container-padding">
          <FadeUp>
            <div className="flex flex-col gap-5 max-w-3xl">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">The Meadows is a premium gated villa community in Dubai's Emirates Living area, featuring large family villas with private gardens and pools. The community is well-established and popular with families looking for spacious, high-quality homes.</p>
              <p className="text-base text-muted-foreground leading-relaxed">WeMoveStuff provides professional villa moving support for The Meadows residents. We handle careful packing, furniture dismantling, transport and reassembly, ensuring every move is managed efficiently and carefully.</p>
            </div>
          </FadeUp>
        </div>
      </section>
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="services-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp><SectionHeader id="services-heading" headline="Moving Services in The Meadows" subheadline="Professional villa and residential moving services across The Meadows." /></FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="process-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp><SectionHeader id="process-heading" headline="How your The Meadows move works" subheadline="A straightforward three-step process from first contact to move completion." /></FadeUp>
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="why-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp><SectionHeader id="why-heading" headline="Why choose WeMoveStuff in The Meadows" subheadline="Professional moving support built around the specific requirements of The Meadows residents." /></FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="faq-heading">
        <div className="max-container container-padding flex flex-col gap-10 max-w-3xl mx-auto">
          <FadeUp><SectionHeader id="faq-heading" headline="The Meadows Moving FAQ" /></FadeUp>
          <FadeUp delay={0.08}><FAQAccordion items={FAQ_ITEMS} /></FadeUp>
        </div>
      </section>

      <CTASection
        headline="Ready to move in The Meadows?"
        body="Get a quote from WeMoveStuff and let our team handle the planning, packing and moving process for your The Meadows property."
        primaryCTA={{ label: "Get a Quote", href: "/quote", variant: "primary" }}
        secondaryCTA={{ label: "WhatsApp Us", href: whatsappUrl, variant: "whatsapp", external: true }}
      />
    </>
