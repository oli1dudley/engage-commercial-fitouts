...
const FEATURES = [
  ...
  },
  {
    ...
    description: "We handle all property types in JVC — apartments, townhouses and villas.",
  },
  {
    icon: MapPin,
...
const FAQ_ITEMS: FAQItem[] = [
  {
    question: "Do you move apartments and villas in JVC?",
    answer:
      "Yes. We handle all property types in JVC — apartments, studios, townhouses and villas. Each move is planned around your specific property and requirements.",
  },
  {
    question: "Can you dismantle and reassemble furniture as part of a JVC move?",
    answer:
      "Yes. Furniture dismantling and reassembly is included as part of the full moving service. We bring all tools and handle all assembly at your new JVC property.",
  },
  {
    question: "Do you offer packing services in JVC?",
    answer:
      "Yes. Full packing and unpacking services are available for JVC moves. We use quality materials to protect all items during transport.",
  },
  {
    question: "How do I book movers in JVC?",
    answer:
      "Submit a quote request through our website or contact us directly. We'll review your move details and respond quickly with a tailored quote for your JVC move.",
  },
];
...
const RELATED_SERVICES = [
  {
    title: "Villa Moving",
    description: "Professional villa relocation services across Dubai.",
    href: "/services/villa-moving",
  },
  {
    title: "Apartment Moving",
  ...
  {
    title: "Furniture Assembly",
    description: "Furniture dismantling and reassembly at your new JVC property.",
    href: "/services/furniture-assembly",
  },
];
...
export default function JvcMoversPage() {
  return (
    <>
      {/* Structured Data */}
      <StructuredData
        data={breadcrumbSchema([
          { name: "Home", url: "/" },
          { name: "JVC Movers", url: "/locations/jvc-movers" },
        ])}
      />
      <StructuredData
        data={serviceSchema({
          name: "Movers in JVC",
          description:
            "Professional movers in Jumeirah Village Circle (JVC) handling apartment, townhouse and villa moves with packing, furniture assembly, transport and full setup.",
          url: "/locations/jvc-movers",
      ...
      {/* ── Section 1: Hero ──────────────────────────────────────────── */}
      <PageHero
        headline="Movers in JVC"
        subheadline="Professional apartment, townhouse and villa moving services across Jumeirah Village Circle, including packing, furniture dismantling, transport and setup."
        body="JVC is a popular community with a mix of apartments, townhouses and villas. WeMoveStuff provides full moving support for all property types in Jumeirah Village Circle — from studio apartments to larger family villas."
          ...
          <FadeUp>
            <div className="flex flex-col gap-5 max-w-3xl">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Jumeirah Village Circle (JVC) is one of Dubai&apos;s most popular residential communities, offering a mix of apartments, townhouses and villas. The community is home to a large number of families and working professionals who move in and out regularly.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                WeMoveStuff supports moves across JVC for all property types — studios, apartments, townhouses and villas. We handle packing, furniture dismantling and reassembly, transport and setup, so the move is organised and straightforward from start to finish.
              </p>
            </div>
          </FadeUp>
        </div>
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="services-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp>
            <SectionHeader
              id="services-heading"
              headline="Moving Services in JVC"
              subheadline="A full range of moving services for apartments, townhouses and villas across Jumeirah Village Circle."
            />
          </FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="process-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp>
            <SectionHeader
              id="process-heading"
              headline="How your JVC move works"
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="why-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp>
            <SectionHeader
              id="why-heading"
              headline="Why choose WeMoveStuff in JVC"
              subheadline="Professional moving support for all property types across Jumeirah Village Circle."
            />
          </FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="faq-heading">
        <div className="max-container container-padding flex flex-col gap-10 max-w-3xl mx-auto">
          <FadeUp>
            <SectionHeader id="faq-heading" headline="JVC Moving FAQ" />
          </FadeUp>
          <FadeUp delay={0.08}>
      ...
      {/* ── Section 9: CTA ───────────────────────────────────────────── */}
      <CTASection
        headline="Ready to move in JVC?"
        body="Get a quote from WeMoveStuff and let our team handle the planning, packing and moving process for your JVC property."
        primaryCTA={{ label: "Get a Quote", href: "/quote", variant: "primary" }}
        secondaryCTA={{ label: "WhatsApp Us", href: whatsappUrl, variant: "whatsapp", external: true }}
      />
    </>
