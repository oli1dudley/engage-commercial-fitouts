...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/locations/al-barsha-movers",
});
...
const FEATURES = [
  ...
  {
    icon: Building2,
    title: "All Al Barsha property types",
    description: "We move apartments, villas and townhouses across Al Barsha 1, 2, 3 and Al Barsha South.",
  },
  {
    icon: MapPin,
...
const FAQ_ITEMS: FAQItem[] = [
  {
    question: "Do you move apartments and villas in Al Barsha?",
    answer:
      "Yes. We handle all property types across Al Barsha, including apartments, villas and townhouses in Al Barsha 1, 2, 3 and Al Barsha South.",
  },
  {
    question: "Do you offer packing services in Al Barsha?",
    answer:
      "Yes. Full packing and unpacking services are available for Al Barsha moves. We supply all materials and protect every item during transport.",
  },
  {
    question: "Can you dismantle and reassemble furniture in Al Barsha?",
    answer:
      "Yes. Furniture dismantling and reassembly is included as part of the full moving service. We bring all tools and handle all assembly at your new Al Barsha property.",
  },
  {
    question: "How do I book movers in Al Barsha?",
    answer:
      "Submit a quote request through our website or contact us directly. We'll review your move details and respond quickly with a tailored quote for your Al Barsha move.",
  },
];

// ─── Page ──────────────────────────────────────────────────────────────────

export default function AlBarshaMoversPage() {
  return (
    <>
      <StructuredData
        data={breadcrumbSchema([
          { name: "Home", url: "/" },
          { name: "Al Barsha Movers", url: "/locations/al-barsha-movers" },
        ])}
      />
      <StructuredData
        data={serviceSchema({
          name: "Movers in Al Barsha",
          description:
            "Professional movers in Al Barsha handling apartment and villa moves with packing, furniture assembly, transport and full setup.",
          url: "/locations/al-barsha-movers",
      ...
      {/* Hero */}
      <PageHero
        headline="Movers in Al Barsha"
        subheadline="Professional apartment and villa moving services across Al Barsha, including packing, furniture dismantling, transport and setup."
        body="Al Barsha is one of Dubai's well-established residential areas. WeMoveStuff provides full moving support for Al Barsha residents across apartments and villas."
          ...
          <FadeUp>
            <div className="flex flex-col gap-5 max-w-3xl">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Al Barsha is one of Dubai&apos;s established residential areas, offering a mix of apartments, villas and townhouses across several sub-communities. The area is centrally located, making it a practical choice for residents across a range of budgets.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                WeMoveStuff provides moving support for Al Barsha residents across all property types. We handle packing, furniture dismantling, transport and reassembly, coordinating the move from start to finish.
              </p>
            </div>
          </FadeUp>
        </div>
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="services-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp>
            <SectionHeader
              id="services-heading"
              headline="Moving Services in Al Barsha"
              subheadline="A full range of moving services for apartments and villas across Al Barsha."
            />
          </FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="process-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp>
            <SectionHeader
              id="process-heading"
              headline="How your Al Barsha move works"
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="why-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp>
            <SectionHeader
              id="why-heading"
              headline="Why choose WeMoveStuff in Al Barsha"
              subheadline="Professional moving support for all property types across Al Barsha."
            />
          </FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="faq-heading">
        <div className="max-container container-padding flex flex-col gap-10 max-w-3xl mx-auto">
          <FadeUp>
            <SectionHeader id="faq-heading" headline="Al Barsha Moving FAQ" />
          </FadeUp>
          <FadeUp delay={0.08}>
      ...
      {/* CTA */}
      <CTASection
        headline="Ready to move in Al Barsha?"
        body="Get a quote from WeMoveStuff and let our team handle the planning, packing and moving process for your Al Barsha property."
        primaryCTA={{ label: "Get a Quote", href: "/quote", variant: "primary" }}
        secondaryCTA={{ label: "WhatsApp Us", href: whatsappUrl, variant: "whatsapp", external: true }}
      />
    </>
