...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/locations/dubai-south-movers",
});
...
const FEATURES = [
  ...
  { icon: Building2, title: "Apartments and villas across Dubai South", description: "We handle all property types in Dubai South, from studio apartments to family villas in the residential zones." },
...
const FAQ_ITEMS: FAQItem[] = [
  { question: "Do you move apartments and villas in Dubai South?", answer: "Yes. We handle all property types in Dubai South — apartments and villas. Each move is planned around your specific requirements." },
  { question: "Do you offer packing services in Dubai South?", answer: "Yes. Full packing and unpacking services are available for Dubai South moves. We supply all materials and protect every item during transport." },
  { question: "Can you dismantle and reassemble furniture in Dubai South?", answer: "Yes. Furniture dismantling and reassembly is included as part of the full moving service. We bring all tools and complete all assembly at your new Dubai South property." },
  { question: "How do I book movers in Dubai South?", answer: "Submit a quote request through our website or contact us directly. We'll review your move details and respond quickly with a tailored quote for your Dubai South move." },
];

export default function DubaiSouthMoversPage() {
  return (
    <>
      <StructuredData data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Dubai South Movers", url: "/locations/dubai-south-movers" }])} />
      <StructuredData data={serviceSchema({ name: "Movers in Dubai South", description: "Professional apartment and villa moving services across Dubai South.", url: "/locations/dubai-south-movers", serviceType: "MovingService" })} />
      <StructuredData data={faqPageSchema(FAQ_ITEMS)} />

      <PageHero
        headline="Movers in Dubai South"
        subheadline="Professional apartment and villa moving services across Dubai South, including packing, furniture dismantling, transport and setup."
        body="Dubai South is a growing residential and mixed-use district in Dubai. WeMoveStuff provides full moving support for Dubai South residents across all property types."
        ...
        trustBadges={["Dubai South Coverage", "Apartments & Villas", "Packing Available", "Furniture Assembly"]}
        variant="centered"
      />
        ...
        <div className="max-container container-padding py-3">
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center flex-wrap gap-1 text-sm">
              ...
              <li><span className="font-medium text-navy" aria-current="page">Dubai South Movers</span></li>
            </ol>
          </nav>
        </div>
      </section>
          ...
          <FadeUp>
            <div className="flex flex-col gap-5 max-w-3xl">
              <h2 id="intro-heading" className="text-[28px] md:text-[36px] lg:text-[44px] font-extrabold text-navy leading-tight tracking-tight text-balance">
                Moving in Dubai South
              </h2>
              <p className="text-base text-muted-foreground leading-relaxed">Dubai South is a large mixed-use development built around Al Maktoum International Airport, featuring a growing residential community with apartments, villas and affordable housing options. The district is popular with airport and logistics professionals.</p>
              <p className="text-base text-muted-foreground leading-relaxed">WeMoveStuff provides full moving support for Dubai South residents across all property types. We handle packing, furniture dismantling, transport and reassembly so your move is efficient and well-organised throughout.</p>
            </div>
          </FadeUp>
        </div>
      </section>
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="services-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp><SectionHeader id="services-heading" headline="Moving Services in Dubai South" subheadline="A full range of moving services for apartments and villas across Dubai South." /></FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="process-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp><SectionHeader id="process-heading" headline="How your Dubai South move works" subheadline="A straightforward three-step process from first contact to move completion." /></FadeUp>
      ...
      <section className="bg-[#F7F9FC] section-padding" aria-labelledby="why-heading">
        <div className="max-container container-padding flex flex-col gap-12">
          <FadeUp><SectionHeader id="why-heading" headline="Why choose WeMoveStuff in Dubai South" subheadline="Professional moving support for all property types across Dubai South." /></FadeUp>
      ...
      <section className="bg-white section-padding" aria-labelledby="faq-heading">
        <div className="max-container container-padding flex flex-col gap-10 max-w-3xl mx-auto">
          <FadeUp><SectionHeader id="faq-heading" headline="Dubai South Moving FAQ" /></FadeUp>
          <FadeUp delay={0.08}><FAQAccordion items={FAQ_ITEMS} /></FadeUp>
        </div>
      </section>

      <CTASection
        headline="Ready to move in Dubai South?"
        body="Get a quote from WeMoveStuff and let our team handle the planning, packing and moving process for your Dubai South property."
        primaryCTA={{ label: "Get a Quote", href: "/quote", variant: "primary" }}
        secondaryCTA={{ label: "WhatsApp Us", href: whatsappUrl, variant: "whatsapp", external: true }}
      />
    </>
